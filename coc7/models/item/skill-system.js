    ...
    return {
      ...
      */
      ...
      properties: new fields.SchemaField({
        ...
        push: new fields.BooleanField({ label: 'CoC7.SkillPush', hint: 'CoC7.SkilllHintPush', initial: false }),
        fighting: new fields.BooleanField({ label: 'CoC7.SkillFighting', hint: 'CoC7.SkilllHintFighting', initial: false }),
        firearm: new fields.BooleanField({ label: 'CoC7.SkillFirearm', hint: 'CoC7.SkilllHintFirearm', initial: false }),
        ranged: new fields.BooleanField({ label: 'CoC7.SkillRanged', hint: 'CoC7.SkilllHintRanged', initial: false }),
