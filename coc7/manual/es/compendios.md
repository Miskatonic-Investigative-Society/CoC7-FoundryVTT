...
* Selecciona la pestaña [fa-solid fa-plug]Módulos
* Haz clic en el botón de [fa-solid fa-gear-code]engranaje
* Establece el Título del paquete; este es el nombre amigable que usas para encontrar el módulo en la lista de módulos
* Selecciona la pestaña [fa-solid fa-book-atlas]Compendios
...
Abre tu mundo y activa el módulo en [fa-solid fa-cogs]Ajustes, en el encabezado de Ajustes del juego, haciendo clic en [fa-solid fa-cube]Administrar módulos.
...
* Haz clic en [fa-solid fa-book-user]Cómo añadir a tu compendio
* Asegúrate de tener la era, el idioma y los módulos correctos activados en [fa-solid fa-cogs]Configuración del Juego
* Selecciona qué tipos de Objeto quieres incluir
* Haz clic en [fa-solid fa-check]Poblar
...
* Haz clic en [game-icon game-icon-tentacle-strike]Herramientas del Guardián
* Haz clic en [fa-solid fa-fingerprint]ID de CoC: Reemplazo de Objeto de Actor
* Selecciona las opciones requeridas
* Haz clic en [fa-solid fa-check]Actualizar
