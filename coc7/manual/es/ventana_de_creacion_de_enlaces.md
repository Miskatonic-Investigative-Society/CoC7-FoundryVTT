...
Está ubicada en la barra lateral izquierda. Haz clic en el icono [fa-solid fa-link].
Esta herramienta está disponible solo para el Guardián (GM).

![Herramienta de creación](../../../static/assets/manual/links/links-creation-tool.webp)
...
![Ventana principal](../../../static/assets/manual/links/main-window.webp)
...
- "Icono" te permite elegir un icono para tu enlace. Los iconos pueden ser:
  - Una referencia a Font Awesome o a game-icons: "fa-solid fa-ankh" o "game-icon game-icon-tentacle-strike".
...
![Etiqueta predeterminada](../../../static/assets/manual/links/default-label.webp)
...
![Enlace creado](../../../static/assets/manual/links/effect-link-creation.webp)
...
![Enlace en el chat](../../../static/assets/manual/links/link-effect-chat.webp)
...
![Soltar enlace](../../../static/assets/manual/links/effect-drop.webp)
