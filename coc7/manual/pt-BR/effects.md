...
Efeitos podem ser criados como um [link](links.md) usando a [Ferramenta de criacao de links](link_creation_window.md), ou diretamente na ficha de personagem clicando no botao [game-icon game-icon-aura].
