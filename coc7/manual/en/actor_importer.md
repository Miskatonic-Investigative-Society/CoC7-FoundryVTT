...
To open the actor importer either open the [fa-solid fa-users]Actor Directory and click Actor Importer at the bottom of the side bar or on an active scene [game-icon game-icon-tentacle-strike] then click [fa-solid fa-user-plus]Actor Importer
...
Click import will create an actor under the [fa-solid fa-users]Actor directory will be created in the Imported characters folder any text that was not understood will be stored in Keeper notes
...
Browse for your JSON file, once selected the name and image will be be shown, click import to create the actor under the [fa-solid fa-users]Actor directory will be created in the Imported characters folder

By default the image will be stored in a folder called dhole-image in your world, this can be changed by clicking on the [fa-solid fa-cogs]Game Settings tab then under the Game Settings heading clicking on [fa-solid fa-cogs]Configure Settings, click on [fa-solid fa-cogs]System Settings.
