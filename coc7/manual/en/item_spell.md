...
- **Prompt: Additional caster prompt: Add**
    ...
    Each time this is added a new group will be added. The number of casters in the group is available using "Number name".length e.g. @casters.length
...
- **Prompt: Additional caster prompt: Enter number**
    ...
    Add a prompt for a number to the current additional caster group. The total number is available using "Previous caster number name"."Number name" e.g. @casters.mp
