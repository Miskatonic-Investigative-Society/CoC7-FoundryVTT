...
const accentedCharacters = regexquote('áéíóàèìòùÀÈÌÒÙáéíóúýÁÉÍÓÚÝâêîôûÂÊÎÔÛãñõÃÑÕäëïöüÿÄËÏÖÜŸçÇßØøÅåÆæœ')
...
export class CoC7ActorImporterRegExp {
  static get optionLangRegExp () { return /coc-(?<langcode>\w\w)/ }
