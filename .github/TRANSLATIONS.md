...
The following translations are currently up to date **cs**, **de**, **sv**
...
[pt-BR.json (196 untranslated strings)](./ABANDONED.md#ptbrjson)

[ru.json (118 untranslated strings)](./ABANDONED.md#rujson)

[zh-TW.json (95 untranslated strings)](./ABANDONED.md#zhtwjson)



|Key|es|fr|it|ja|pl|uk|
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
|**Remaining**:|**10**|**1**|**38**|**2**|**19**|**1**|
