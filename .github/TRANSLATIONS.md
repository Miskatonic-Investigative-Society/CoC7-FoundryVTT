...
The following translations have more than 100 untranslated strings **cn**, **cs**, **es**, **ja**, **pt-BR**, **ru**, **sv**, [are you able to help?](./ABANDONED.md)

|Key|de|fr|ko|pl|zh-TW|
|:---|:---:|:---:|:---:|:---:|:---:|
|**Remaining**:|**38**|**38**|**52**|**40**|**41**|
