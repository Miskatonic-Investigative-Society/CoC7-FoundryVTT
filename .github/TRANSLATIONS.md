...
The following translations are currently up to date **it**, **pl**

The following translations have been abandoned **cn**, **cs**, **de**, **es**, **ja**, [are you able to help?](./ABANDONED.md)

|Key|fr|ko|pt-BR|sv|zh-TW|
|:---|:---:|:---:|:---:|:---:|:---:|
|**Remaining**:|**198**|**199**|**82**|**198**|**198**|
...
##### SETTINGS.TrustedCanModfyChatCardHint
