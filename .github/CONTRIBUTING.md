...
In order to run tests and see if you didn't introduce breaking changes, download [secondary repository with e2e Quench tests](https://github.com/snap01/coc7-quench-tests) and follow setup instructions there.
