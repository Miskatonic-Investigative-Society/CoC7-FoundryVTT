...
try {
  for (const lang in sources) {
    ...
    for (const page in sources[lang].pages) {
      ...
      let input = fs.readFileSync(rootFolder + '/coc7/manual/' + lang + '/' + sources[lang].pages[page].file, 'utf8')
      ...
      fs.writeFileSync(rootFolder + '/docs/' + lang + '/' + sources[lang].pages[page].file, '<!--- DO NOT EDIT. This file is automatically generated from coc7/manual/' + lang + '/' + sources[lang].pages[page].file + ' changes made to this file will be lost -->\n' + mdFile, { flag: 'w+' })
