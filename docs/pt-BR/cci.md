<!--- DO NOT EDIT. This file is automatically generated from coc7/manual/pt-BR/cci.md changes made to this file will be lost -->
# Interface Chaosium Canvas

O FoundryVTT v12 implementou Regioes de Cena, que permitem acionar Comportamentos com base em interacoes de tokens.
...
Voce pode obter o UUID de Desenhos, Luzes, Notas de Mapa, Regioes de Cena e Tiles clicando no botao Copiar UUID do Documento no cabecalho.

Se estiver usando FoundryVTT v14, a aba Placeables permite arrastar e soltar Desenhos, Notas de Mapa, Regioes de Cena e Tiles em vez de copiar o UUID.

Se estiver usando FoundryVTT v13, voce pode arrastar Regioes de Cena e Comportamentos de Regiao para a aba Comportamentos para duplica-los em sua nova Regiao de Cena.
